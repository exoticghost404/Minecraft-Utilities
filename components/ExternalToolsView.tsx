...
export const TOOLS = [
  ...
  {
    name: 'Brewing Guide',
    url: 'https://www.digminecraft.com/brewing_recipes/index.php',
    description: 'Complete interactive guide for brewing recipes and potion ingredients.',
    icon: FlaskConical,
    color: 'purple'
  },
  {
            ...
            {filteredTools.map((tool) => {
                ...
                return (
                    <a 
                        ...
                        className="group bg-zinc-900 border border-zinc-800 rounded-xl p-5 hover:border-zinc-600 hover:bg-zinc-800 transition-all flex items-start gap-4 hover:shadow-lg hover:-translate-y-1"
                    >
                        <div className={`
                            p-3 rounded-lg bg-zinc-950 border border-zinc-800 shadow-inner group-hover:scale-110 transition-transform
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="flex items-center justify-between mb-1">
                                <h3 className="font-bold text-zinc-100 group-hover:text-indigo-300 transition-colors">
                                    {tool.name}
                                </h3>
